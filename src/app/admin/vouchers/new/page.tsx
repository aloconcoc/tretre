...
export default function NewVoucherPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      ...
      setError(data.error ?? 'Tạo voucher thất bại.');
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-comay-charcoal">Tạo Voucher Mới</h1>
          <p className="text-gray-500">Thiết lập mã giảm giá cho khách hàng</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors">
              ...
              />
              <div>
                <p className="font-semibold text-comay-charcoal">Kích hoạt ngay</p>
                <p className="text-sm text-gray-500">Voucher có thể sử dụng ngay sau khi tạo</p>
              </div>
            </label>
          </div>
        </div>
