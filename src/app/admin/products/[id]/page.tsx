...
export default function EditProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (images.length === 0) {
      setError('Vui lòng có ít nhất 1 hình ảnh.');
      return;
    }
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-comay-charcoal">Chỉnh Sửa Sản Phẩm</h1>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-comay-green transition-colors resize-none"
                placeholder="Mô tả đầy đủ, xuống dòng để tách đoạn..."
              />
            </div>
